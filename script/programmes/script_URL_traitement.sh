...
echo 	"<html>
			...
			<body>
							...
							<table class=\"table is-bordered is-striped is-narrow is-hoverable is-fullwidth\">
									<thead><tr><th>ID</th><th>code HTTP</th><th>URL</th><th>Encodage</th><th>HTML</th><th>Dump</th><th>Occurences</th><th>Contextes</th><th>Concordances</th></tr></thead>" > ./tableaux/$fichier_tableau # dirige le site en supprimant le contenu du fichier entier précédent
